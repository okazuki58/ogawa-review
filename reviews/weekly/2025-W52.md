...
- performance-review カスタムスキル設計とプロトタイプ作成
...
**xincere-review システム設計（12/25）**
- performance-review / xincere-review 周りで、目標分解と週次自動振り返りの骨子を設計
...
- **performance-review スキルの開発**：カスタムスキル設計、テンプレート整備
...
- 新規プロジェクト（performance-review、xincere-review）の立ち上げに時間を割いた
...
4. **xincere-review / performance-review**
...
- **performance-review / xincere-review**：目標分解と週次自動振り返りの骨子を設計できたため、個人の運用フローと社内展開の基盤が整いつつある
